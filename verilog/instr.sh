...
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_simple.list proc_hier_pbench *.v
mv summary.log $RPATH/instTests.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_complex.list proc_hier_pbench *.v
mv summary.log $RPATH/complex.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_ran_simple.list proc_hier_pbench *.v
mv summary.log $RPATH/rand_simple.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_ran_complex.list proc_hier_pbench *.v
mv summary.log $RPATH/rand_complex.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_ran_ctrl.list proc_hier_pbench *.v
mv summary.log $RPATH/rand_ctrl.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_ran_mem.list proc_hier_pbench *.v
mv summary.log $RPATH/rand_mem.summary.log
$SPATH/wsrun.pl -brief -pipe -list $LPATH/all_demo_two.list proc_hier_pbench *.v
